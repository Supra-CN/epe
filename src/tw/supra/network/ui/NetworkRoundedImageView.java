...
import tw.supra.network.cache.SimpleImageLoader;
 ...
 * associated request.
 */
public class NetworkRoundedImageView extends AnimateRoundedImageView {
	 ...
	 * {@link NetworkRoundedImageView#setDefaultImageResId(int)} on the view.
	 *
	 * NOTE: If applicable, {@link NetworkRoundedImageView#setDefaultImageResId(int)}
	 * and {@link NetworkRoundedImageView#setErrorImageResId(int)} should be called
	...
	void loadImageIfNecessary(final boolean isInLayoutPass) {
		...
		if (mImageLoader instanceof SimpleImageLoader) {
			...
			maxWidth = mMaxImageWidth == 0 ? loader.getMaxImageWidth()
					: mMaxImageWidth;
			maxHeight = mMaxImageHeight == 0 ? loader.getMaxImageHeight()
					: mMaxImageHeight;
		} else {
				...
				new ImageListener() {
					...
					public void onResponse(final ImageContainer response,
						...
						if (response.getBitmap() != null) {
							...
							// mFadeInImage);
							setAnimateImageBitmap(response.getBitmap(),
									mFadeInImage);
							if (null != mListener) {
			...
			animate().scaleY(0.95f).scaleX(0.95f).alpha(0f)
					...
					.setListener(new AnimatorListenerAdapter() {
						...
						public void onAnimationEnd(Animator animation) {
							...
							animate().alpha(1f).scaleY(1f).scaleX(1f)
