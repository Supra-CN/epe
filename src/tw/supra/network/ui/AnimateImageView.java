 ...
 */
public class AnimateImageView extends ImageView implements
		Animation.AnimationListener {

	/**
	 * Whether changes to this imageview should be animated or not
	 */
	...
	/**
	 * The different types of image resources possible. Used to animate the
	 * images when changing
	 */
	...
	/**
	 * The Image Ids to be used when the out animation ends and the fade
	 * animation begins
	 */
	...
	private void init(Context context, AttributeSet attrs) {
		...
		if (attrs == null) {
			...
			if (attributes == null) {
				...
				mShouldAnimateChanges = attributes.getBoolean(
						R.styleable.AnimateImageView_animate_changes, false);
				int inAnimationResId = attributes.getResourceId(
						R.styleable.AnimateImageView_in_animation, 0);
				int outAnimationResId = attributes.getResourceId(
						R.styleable.AnimateImageView_out_animation, 0);
				attributes.recycle();
	 ...
	 * 
	 * @param animateChanges
	 *            whether to animate the changes or not
	 */
	 ...
	 * 
	 * @param outAnimation
	 *            The animation to remove an image
	 */
