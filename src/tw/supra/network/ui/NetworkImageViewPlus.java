...
import tw.supra.network.cache.plus.ImageLoader;
import tw.supra.network.cache.plus.ImageLoader.ImageContainer;
import tw.supra.network.cache.plus.ImageLoader.ImageListener;
import tw.supra.network.cache.plus.SimpleImageLoader;
	...
	private void setAnimateImageBitmap(final BitmapDrawable bitmap,
		...
		if (fadeIn && Utils.hasHoneycombMR1()) {
			...
			final TransitionDrawable td = new TransitionDrawable(
					new Drawable[] { initialDrawable, bitmap });
			setImageDrawable(td);
