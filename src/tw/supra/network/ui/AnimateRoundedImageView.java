 ...
 */
public class AnimateRoundedImageView extends RoundedImageView implements Animation.AnimationListener{
    ...
    public AnimateRoundedImageView(Context context) {
        this(context, null);
        init(context, null);
    }

    public AnimateRoundedImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
        init(context, attrs);
    }

    public AnimateRoundedImageView(Context context, AttributeSet attrs, int defStyle) {
