 ...
 *
 * Calling {@link #add(Request)} will add the request to request tickle and
 * {@link #start()}, will give a {@link NetworkResponse}. The listeners in the
 * request will also be notified.
 */
public class RequestTickle {
	...
	public RequestTickle(Cache cache, Network network) {
		this(cache, network, new ExecutorDelivery(new Handler(
	...
	public NetworkResponse start() {
		...
		try {
			...
			if (networkResponse.notModified
					&& mRequest.hasHadResponseDelivered()) {
