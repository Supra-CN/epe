...
public abstract class EpeJsonMultiRequest<T extends EpeRequestInfo> extends EpeStringMultiRequest<T> {
    private static final String LOG_TAG = EpeJsonMultiRequest.class.getSimpleName();

    public EpeJsonMultiRequest(NetWorkHandler<T> eventHandler, T info) {
