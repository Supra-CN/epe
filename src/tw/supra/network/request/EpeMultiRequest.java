...
abstract public class EpeMultiRequest<T extends EpeRequestInfo> extends
		InfoMultiRequest<EpeErrorCode, T> {
	private static final String LOG_TAG = EpeMultiRequest.class.getSimpleName();

	public EpeMultiRequest(NetWorkHandler<T> eventHandler, T info) {
