...
public abstract class EpeStringMultiRequest<T extends EpeRequestInfo> extends EpeMultiRequest<T> {

    public EpeStringMultiRequest(NetWorkHandler<T> eventHandler, T info) {
        super(eventHandler, info);
    }

    private static final String LOG_TAG = EpeStringMultiRequest.class.getSimpleName();
