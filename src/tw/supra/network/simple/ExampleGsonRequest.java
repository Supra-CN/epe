...
import tw.supra.network.request.GsonRequest;
import tw.supra.network.util.MyClass;
import tw.supra.network.util.MyVolley;
 ...
 *
 */
public class ExampleGsonRequest extends BaseActivity {
