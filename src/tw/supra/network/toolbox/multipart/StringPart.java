package tw.supra.network.toolbox.multipart;
...
public final class StringPart extends BasePart {
	...
	public StringPart(String name, String value, String charset) {
		...
		headersProvider = new IHeadersProvider() {
			...
			public String getContentTransferEncoding() {
				return HEADER_CONTENT_TRANSFER_ENCODING + COLON_SPACE
						+ EIGHT_BIT;
			}
		};
	}
	...
	public void writeTo(final OutputStream out, Boundary boundary)
			throws IOException {
