...
import tw.supra.network.cache.BitmapCache;
import tw.supra.network.error.VolleyError;
import tw.supra.network.request.ImageRequest;
...
public class ImageLoader {
	...
	public ImageContainer set(String requestUrl, ImageListener imageListener,
		...
		// The bitmap did not exist in the cache, fetch it!
		ImageContainer imageContainer = new ImageContainer(bitmap, requestUrl,
				cacheKey, imageListener);
	...
	protected Request<Bitmap> makeImageRequest(String requestUrl, int maxWidth,
		...
		return new ImageRequest(requestUrl, mResources, mContentResolver,
				new Listener<Bitmap>() {
					@Override
