...
public class SplashActivity extends BaseActivity implements IdleHandler {
    ...
    private static final int TIME_LOCKED = BuildConfig.DEBUG ? 0 : 1000;// 锁屏时间
...
//                && CommonData.getInstance().getPrefBool(PreferencesCommon.FIRST_LAUNCH, true)) {
//            startActivity(new Intent(this, SetOutActivity.class));
//            CommonData.getInstance().putPrefBool(PreferencesCommon.FIRST_LAUNCH, false);
//        } else {
//            if (BuildConfig.DEBUG) {
