...
public class SupraPullToRefreshExpandableListView extends
		SupraPullToRefreshAdapterViewBase<ExpandableListView> {

	public SupraPullToRefreshExpandableListView(Context context) {
		super(context);
	}
	...
	public SupraPullToRefreshExpandableListView(Context context, Mode mode) {
		super(context, mode);
	}
	...
	class InternalExpandableListView extends ExpandableListView implements
		...
		public void setEmptyView(View emptyView) {
			SupraPullToRefreshExpandableListView.this.setEmptyView(emptyView);
		}
	...
	final class InternalExpandableListViewSDK9 extends
		...
		protected boolean overScrollBy(int deltaX, int deltaY, int scrollX,
			...
			OverscrollHelper.overScrollBy(
					SupraPullToRefreshExpandableListView.this, deltaX, scrollX,
