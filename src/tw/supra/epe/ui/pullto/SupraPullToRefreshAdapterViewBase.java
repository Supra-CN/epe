...
public abstract class SupraPullToRefreshAdapterViewBase<T extends AbsListView>
	...
	private static final String LOG_TAG = SupraPullToRefreshAdapterViewBase.class
			.getSimpleName();
	...
	public SupraPullToRefreshAdapterViewBase(Context context) {
		super(context);
		mRefreshableView.setOnScrollListener(this);
	}

	public SupraPullToRefreshAdapterViewBase(Context context, AttributeSet attrs) {
		super(context, attrs);
		mRefreshableView.setOnScrollListener(this);
	}

	public SupraPullToRefreshAdapterViewBase(Context context, Mode mode) {
		super(context, mode);
		mRefreshableView.setOnScrollListener(this);
	}
