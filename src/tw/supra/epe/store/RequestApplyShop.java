...
public class RequestApplyShop extends EpeJsonRequest<EpeRequestInfo> {
	private static final String LOG_TAG = RequestApplyShop.class
			.getSimpleName();

	private final String CODE;
	private final String MOBILE;
	private final ObjShop SHOP;
	...
	private static EpeRequestInfo createInfo() {
		return new EpeRequestInfo() {
			...
			protected void fillQueryParamters(HashMap<String, String> paramters) {
				...
				paramters.put("m", "addShop");
			}
		};
	}

	public RequestApplyShop(NetWorkHandler<EpeRequestInfo> eventHandler,
			String code, String mobile,  
			ObjShop shop, String doorNo) {
	...
	protected Map<String, String> getParams() throws AuthFailureError {
		...
		p.put("code", CODE);
		p.put("mobile", MOBILE);
		p.put("floor_id", SHOP.floor);
		p.put("mall_id", SHOP.mallId);
		p.put("brand_id", SHOP.brandId);
