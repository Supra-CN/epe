...
public class StoreProductPage extends BaseFrag implements OnClickListener,
		NetWorkHandler<WorthInfo>, LocationCallBack, OnItemClickListener,
		OnRefreshListener2<StaggeredGridView> {
	private static final String LOG_TAG = StoreProductPage.class
			.getSimpleName();
	...
	public void onItemClick(StaggeredGridView parent, View view, int position,
			long id) {
		try {
			String productId = DATA_SET.get(position).getString(
					WorthInfo.ATTR_PRODUCT_ID);
