...
import tw.supra.epe.account.RegInfo;
import tw.supra.epe.account.RequestReg;
...
public class ApplyMallPage extends BaseHostFrag<ApplyStoreActivity> implements
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View v = inflater.inflate(R.layout.page_apply_mall_store, container, false);
...
//		mBtnReg.setOnClickListener(this);
	...
	private void requestPhoneRegister(String phoneNum, String passWord,
			String verifyCode) {
		...
		NetworkCenter.getInstance()
				.putToQueue(new RequestReg(HANDLE_REG, info));
	}
