...
public class RequestFocusMall extends EpeJsonRequest<FocusMallInfo> {
	private static final String LOG_TAG = RequestFocusMall.class
			.getSimpleName();

	public RequestFocusMall(NetWorkHandler<FocusMallInfo> eventHandler,
			FocusMallInfo info) {
