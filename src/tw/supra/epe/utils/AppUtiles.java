...
public class AppUtiles {
    ...
    private static final String DIR_SAVE_TMP_IMAGE = Environment.getExternalStorageDirectory()
            .getPath()
            + "/epe/tmp";
    ...
    public static int doTakePhoto(Activity activity) {
        ...
        try {
            ...
            Toast.makeText(activity, R.string.img_picker_toast_can_not_find_camera,
...
//        return REQUEST_CODE_FOR_PICK;
         ...
         Toast.makeText(activity, R.string.img_picker_toast_can_not_find_gallery,
         Toast.LENGTH_SHORT).show();
         e.printStackTrace();
         return -1;
         }
	...
	public static int doPickVideoFromGallery(Activity activity){
		...
		activity.startActivityForResult(pickVideoIntent, REQUEST_CODE_FOR_PICK_VIDEO);
