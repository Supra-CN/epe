...
public class EpePage extends BaseMainPage implements LocationListener {
	...
	// private final ArrayList<JSONObject> DATA_SET = new
	// ArrayList<JSONObject>();

	private LinearLayout mNearStoreContainer;
	private LinearLayout mNearBrandContainer;

	@Override
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
			Bundle savedInstanceState) {
		View v = inflater.inflate(R.layout.page_epe, null);
		mNearStoreContainer = (LinearLayout) v
				.findViewById(R.id.near_store_container);
		mNearBrandContainer = (LinearLayout) v
	...
	private View createNearBrandView(JSONObject joItem, int postion)
			throws JSONException {
		View v = View.inflate(getActivity(), R.layout.epe_page_brand_item, null);
