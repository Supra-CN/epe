...
public class WorthInfo extends EpeRequestInfo {
	...
	public final boolean ARG_DISCOUNT;// 参数：折扣排序 1 是 0 否 默认为0；

	/**
	 * 参数：性别，默认 {@link #GENDER_UNKNOW}
	 */
	public final String ARG_GENDER;
...
//	public final int ARG_COUNT;// 参数：条数
	...
	public WorthInfo(double latitude, double longitude, boolean discount,
			String gender, int page) {
...
//		ARG_COUNT = count;
	...
	protected void fillQueryParamters(HashMap<String, String> paramters) {
		...
		paramters.put("sex", ARG_GENDER);
		paramters.put("discount", ARG_DISCOUNT ? "1" :"0");
